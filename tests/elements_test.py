...
class TestElements:
    ...
    class TestTextBox:
        ...
        def test_text_box(self, driver):
            ...
            assert current_address == output_cur_adr, "the current address does not match"
            assert permanent_address == output_per_adr, "the permanent address does not match"
    ...
    class TestUploadAndDownload:
        ...
        def test_upload_file(self, driver):
            ...
            file_name, text = upload_download_page.upload_file()
            assert file_name == text, "the file has not been uploaded"
    ...
    class TestDynamicProperties:
        ...
        def test_enable_button(self, driver):
            ...
            assert enable is True, "buttons did not enable 5 second"
        ...
        def test_appear_button(self, driver):
            ...
            assert appear is True, "buttons did not appear 5 second"
